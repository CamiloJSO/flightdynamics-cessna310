...
% script to test trimConditionsTurn function to calculate steady
% turn flight conditions for a fixed wing aircraft
...
n = loadFactor(V,h,alpha,phi,theta,[0;0;turnRate],0,ih,deltae,aircraft)
fval
flag